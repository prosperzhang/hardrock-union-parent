...
import com.hardrockunion.business.project.service.PmhubWorkerAttendanceService;
...
@RestController
@RequestMapping("/api/pmhub/worker-attendances")
@Tag(name = "PMHUB-工人考勤", description = "PMHub 工人考勤管理，基于实名进场记录承接签到和签退流程")
public class PmhubWorkerAttendanceController {

    private final PmhubWorkerAttendanceService workerAttendanceService;

    public PmhubWorkerAttendanceController(PmhubWorkerAttendanceService workerAttendanceService) {
    ...
    @GetMapping
    public Result<PageResponse<PmhubWorkerAttendanceResponse>> list(PmhubWorkerAttendanceQueryRequest request, LoginUser loginUser) {
    ...
    @GetMapping("/{id}")
    public Result<PmhubWorkerAttendanceResponse> get(@Parameter(description = "考勤记录 ID", example = "68290000000000001")
    ...
    public Result<PmhubWorkerAttendanceResponse> checkIn(@RequestBody PmhubWorkerAttendanceCheckInRequest request,
                                                        LoginUser loginUser) {
    ...
    public Result<PmhubWorkerAttendanceResponse> checkOut(@Parameter(description = "考勤记录 ID", example = "68290000000000001")
                                                         @PathVariable("id") Long id,
                                                         @RequestBody(required = false) PmhubWorkerAttendanceActionRequest request,
                                                         LoginUser loginUser) {
