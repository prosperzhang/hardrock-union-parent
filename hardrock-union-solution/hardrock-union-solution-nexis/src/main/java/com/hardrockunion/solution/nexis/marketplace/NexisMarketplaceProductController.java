package com.hardrockunion.solution.nexis.marketplace;
...
@RestController
@RequestMapping("/api/nexis/marketplace/products")
@Tag(name = "NEXIS-商城商品", description = "NEXIS 项目侧商城商品查询")
public class NexisMarketplaceProductController {

    private final MerchantProductService merchantProductService;

    public NexisMarketplaceProductController(MerchantProductService merchantProductService) {
        this.merchantProductService = merchantProductService;
    }

    @Operation(summary = "商城商品分页列表", description = "按当前 NEXIS 项目租户行政区域匹配区县、市、省区域价，未配置时回退商品基础价。")
    @GetMapping
