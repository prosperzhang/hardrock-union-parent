...
public enum PmhubSiteWorkScopeType {
    ...
    PmhubSiteWorkScopeType(String code, String label, String description) {
        this.code = code;
        this.label = label;
    ...
    public static PmhubSiteWorkScopeType fromCode(String code) {
