...
public enum PmhubParticipantRole {
    ...
    PmhubParticipantRole(String code, String label, String description) {
        this.code = code;
        this.label = label;
    ...
    public static PmhubParticipantRole fromCode(String code) {
