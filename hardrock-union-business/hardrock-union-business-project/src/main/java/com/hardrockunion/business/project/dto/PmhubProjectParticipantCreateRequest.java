...
@Schema(name = "PmhubProjectParticipantCreateRequest", description = "pmhub 项目参建关系创建请求")
public class PmhubProjectParticipantCreateRequest {
    ...
    @Schema(description = "项目角色，可通过 /api/pmhub/dictionaries/participant-roles 获取字典", example = "LABOR_CONTRACTOR",
