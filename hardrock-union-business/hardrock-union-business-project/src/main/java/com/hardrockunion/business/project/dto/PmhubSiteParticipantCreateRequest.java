...
@Schema(name = "PmhubSiteParticipantCreateRequest", description = "pmhub 标段参建关系创建请求")
public class PmhubSiteParticipantCreateRequest {
    ...
    @Schema(description = "现场角色，可通过 /api/pmhub/dictionaries/participant-roles 获取字典", example = "LABOR_CONTRACTOR",
