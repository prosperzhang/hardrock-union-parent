...
@Schema(name = "PmhubSiteWorkScopeCreateRequest", description = "pmhub 标段施工范围创建请求")
public class PmhubSiteWorkScopeCreateRequest {
    ...
    @Schema(description = "范围类型，可通过 /api/pmhub/dictionaries/site-work-scope-types 获取字典", example = "CODE_RANGE",
