...
@Schema(name = "NexisParticipantCompanyQueryRequest", description = "nexis 参建单位分页查询条件")
public class NexisParticipantCompanyQueryRequest extends PageRequest {

    @Schema(description = "关键词，匹配单位名称、单位编码、联系人和联系电话", example = "甲劳务")
    private String keyword;

    @Schema(description = "单位类型筛选，可通过 /api/nexis/dictionaries/participant-company-types 获取字典", example = "LABOR_CONTRACTOR",
