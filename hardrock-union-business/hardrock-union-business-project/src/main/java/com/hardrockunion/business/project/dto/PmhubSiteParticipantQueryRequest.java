...
@Schema(name = "PmhubSiteParticipantQueryRequest", description = "pmhub 标段参建关系分页查询条件")
public class PmhubSiteParticipantQueryRequest extends PageRequest {
    ...
    @Schema(description = "现场角色筛选，可通过 /api/pmhub/dictionaries/participant-roles 获取字典", example = "LABOR_CONTRACTOR",
