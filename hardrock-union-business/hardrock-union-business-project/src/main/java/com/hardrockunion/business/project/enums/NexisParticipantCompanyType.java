...
public enum NexisParticipantCompanyType {
    ...
    NexisParticipantCompanyType(String code, String label, String description) {
        this.code = code;
        this.label = label;
    ...
    public static NexisParticipantCompanyType fromCode(String code) {
