...
@Schema(name = "PmhubParticipantCompanyCreateRequest", description = "pmhub 参建单位创建请求")
public class PmhubParticipantCompanyCreateRequest {
    ...
    @Schema(description = "单位类型，可通过 /api/pmhub/dictionaries/participant-company-types 获取字典", example = "LABOR_CONTRACTOR",
