...
@Schema(name = "PmhubSiteParticipantResponse", description = "pmhub 标段参建关系响应")
public class PmhubSiteParticipantResponse {

    @Schema(description = "标段参建关系 ID", example = "68262140034686978")
    private Long id;
    ...
    @Schema(description = "现场角色", example = "LABOR_CONTRACTOR")
    private String participantRole;
    @Schema(description = "现场角色名称", example = "劳务分包")
