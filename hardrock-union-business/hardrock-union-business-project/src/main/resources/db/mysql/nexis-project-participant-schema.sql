CREATE TABLE IF NOT EXISTS nexis_participant (
    ...
    UNIQUE KEY uk_nexis_participant_unique (project_id, participant_company_id, participant_role),
    KEY idx_nexis_participant_tenant_project (tenant_id, project_id, status),
    KEY idx_nexis_participant_company (participant_company_id)
