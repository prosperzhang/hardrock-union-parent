...
@Schema(name = "PmhubProjectParticipantQueryRequest", description = "pmhub 项目参建关系分页查询条件")
public class PmhubProjectParticipantQueryRequest extends PageRequest {
    ...
    @Schema(description = "项目角色筛选，可通过 /api/pmhub/dictionaries/participant-roles 获取字典", example = "LABOR_CONTRACTOR",
