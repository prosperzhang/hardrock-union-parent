CREATE TABLE IF NOT EXISTS tenant_registry (
    ...
    parent_tenant_id BIGINT DEFAULT NULL COMMENT '父级租户ID。NEXIS 公司可挂集团，项目可挂集团或公司',
    ...
    external_owner_name VARCHAR(128) DEFAULT NULL COMMENT '外部上级单位名称。用于A公司未入驻时记录上级单位',
    external_project_name VARCHAR(128) DEFAULT NULL COMMENT '外部上级项目名称。用于记录对方的大项目名称',
    contract_scope_name VARCHAR(128) DEFAULT NULL COMMENT '我的承包范围/施工段名称',
