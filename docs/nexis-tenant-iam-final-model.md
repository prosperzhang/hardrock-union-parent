# Nexis TenantRegistry/IAM Final Model

## 1. Core Conclusion

Nexis now uses the unified `tenant + iam` model.
...
Nexis business code no longer owns project membership, project join request, or project role assignment.
...
- creator enters `NEXIS_DECISION_DEPT`
- creator gets `NEXIS_DECISION_LEADER`
...
### Nexis business responsibility

- sites
- workers
- entries
- attendance
- other pure Nexis business data

## 7. Final Summary

The final Nexis model is:
