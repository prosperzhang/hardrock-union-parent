...
@Schema(name = "NexisSiteWorkScopeQueryRequest", description = "nexis 标段施工范围分页查询条件")
public class NexisSiteWorkScopeQueryRequest extends PageRequest {
    ...
    @Schema(description = "范围类型筛选，可通过 /api/nexis/dictionaries/site-work-scope-types 获取字典", example = "CODE_RANGE",
